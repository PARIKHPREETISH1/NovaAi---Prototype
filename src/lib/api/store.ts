// In-memory store seeded with believable data. Mutations from the API layer
// update this store so the app behaves statefully across navigation.
...
const buildCampaign = (
  ...
  const c: Campaign = {
    ...
    newsletters: PERSONAS.map((p) =>
      buildNewsletter(topic, p, status === "sent" || status === "approved" ? "approved" : "pending")
    ),
  };
  if (withMetrics) {
    c.metrics = {
    ...
    c.insights = [
      { id: `${id}-i1`, tone: "win", text: "Strategist open rate outperformed benchmark by 18%. Subject lines anchored on margin language continue to win." },
      { id: `${id}-i2`, tone: "info", text: "Builder CTR is steady but link placement above the code snippet would likely add 1–2 points." },
      { id: `${id}-i3`, tone: "warn", text: "Explorer engagement dipped 6% week-over-week. Consider a more visual hook or shorter subject (<40 chars)." },
    ];
    c.hubspotLog = [
...
// Mutable in-memory data — acts as the "database" for the mock API.
export const db = {
  campaigns: [
  ...
  contacts: [
    { id: "1", name: "Maya Lindqvist", email: "maya@nordstudio.co", persona: "STRATEGIST", hubspot: "synced", created: "2025-01-12" },
    { id: "2", name: "Daniel Okafor", email: "dan@buildhouse.io", persona: "BUILDER", hubspot: "synced", created: "2025-01-14" },
    { id: "3", name: "Priya Raman", email: "priya@solo.studio", persona: "EXPLORER", hubspot: "pending", created: "2025-01-18" },
    { id: "4", name: "Tomás Vidal", email: "tomas@vidalandco.com", persona: "STRATEGIST", hubspot: "synced", created: "2025-01-19" },
    { id: "5", name: "Avery Chen", email: "avery@chen.work", persona: "BUILDER", hubspot: "failed", created: "2025-01-20" },
    { id: "6", name: "Lena Hoffmann", email: "lena@hoffmann.dev", persona: "EXPLORER", hubspot: "synced", created: "2025-01-22" },
    { id: "7", name: "Idris Bello", email: "idris@bellocreative.com", persona: "STRATEGIST", hubspot: "synced", created: "2025-01-25" },
    { id: "8", name: "Sara Kowalski", email: "sara@kowalski.studio", persona: "BUILDER", hubspot: "synced", created: "2025-02-01" },
    { id: "9", name: "Jamal Reeves", email: "jamal@reevesco.io", persona: "EXPLORER", hubspot: "synced", created: "2025-02-04" },
    { id: "10", name: "Hiroshi Tanaka", email: "h.tanaka@tnk.jp", persona: "STRATEGIST", hubspot: "synced", created: "2025-02-08" },
    { id: "11", name: "Noor Al-Sayed", email: "noor@alsayed.design", persona: "BUILDER", hubspot: "pending", created: "2025-02-11" },
    { id: "12", name: "Eli Bergström", email: "eli@bergstrom.co", persona: "EXPLORER", hubspot: "synced", created: "2025-02-14" },
  ] as Contact[],

  topics: [
    { id: "t1", topic: "Selling AI services to skeptical clients", confidence: 92, rationale: "High intent in Builder segment based on last 3 campaigns." },
    { id: "t2", topic: "The agency P&L in an AI-native world", confidence: 88, rationale: "Strategist persona engagement up 18% on margin topics." },
    { id: "t3", topic: "Prompt patterns for creative directors", confidence: 81, rationale: "Explorer cohort showing curiosity around tactical prompts." },
    { id: "t4", topic: "From freelancer to micro-agency in 90 days", confidence: 76, rationale: "Strong Explorer signal; aligns with Q2 content theme." },
  ] as TopicSuggestion[],
  ...
  globalInsights: [
    { id: "g1", tone: "win", text: "Strategist segment continues to outperform — open rate 51.2% vs 43.2% average. Double down on margin/ROI angles." },
    { id: "g2", tone: "warn", text: "Explorer engagement is down 6% week-over-week. Test shorter subject lines (<40 chars) and add a visual hook." },
    { id: "g3", tone: "info", text: "Tuesday 09:00 UTC sends are outperforming Friday by 4.2 pts on open rate. Consider shifting cadence." },
    { id: "g4", tone: "win", text: "Builder CTR holds at 8.4% — link placement above code snippets correlates with +1.6 pts lift." },
  ] as AIInsight[],
};

export const buildBlogFor = buildBlog;
export const buildCampaignFor = buildCampaign;
